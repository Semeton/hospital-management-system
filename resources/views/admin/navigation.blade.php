                     ...
                     <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                         ...
                         <a class="dropdown-item preview-item" href="{{url('add_doctor_view')}}">
                             ...
                             <div class="preview-item-content">
                                 <p class="preview-subject ellipsis mb-1">Doctors</p>
                             </div>
                         </a>
                         <div class="dropdown-divider"></div>
                         <a class="dropdown-item preview-item">
                             ...
                             <div class="preview-item-content">
                                 <p class="preview-subject ellipsis mb-1">Appointments</p>
                             </div>
                         </a>
                         <div class="dropdown-divider"></div>
                         <a class="dropdown-item preview-item">
                             ...
                             <div class="preview-item-content">
                                 <p class="preview-subject ellipsis mb-1">Diagnostic Testing</p>
                             </div>
                         </a>
                         <div class="dropdown-divider"></div>
